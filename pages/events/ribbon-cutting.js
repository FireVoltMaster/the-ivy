...
export default function RibbonCutting() {
  ...
  return (
    <div className="bg-white overflow-hidden">
      <Head>
          <title>Ribbon cutting ceremony 9.3.22</title>
          <meta name="description" content="Ribbon cutting ceremony on 9.3.22 at The Ivy in Long Beach, New York." />
          ...
          <div className="relative lg:row-start-1 lg:col-start-2">
            ...
            <div className="relative text-base mx-auto max-w-prose lg:max-w-none">
              ...
              {/* {eventDeets.map((deet) => (
                ...
                <div className="lg:aspect-none">
                    <Image 
                      src='/images/events/ribbon-cutting.png'    // 👈 HARD CODE IMAGE HERE FOR NOW
                      alt="Flyer"
                      width={1184}
                      height={1376}
