...
const navigation = {
  ...
  export default function Footer() {
    return (
      <footer className="bg-white inset-x-0 bottom-0" aria-labelledby="footer-heading">
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          ...
          <div className="mt-12 border-t border-gray-200 pt-8">
            ...
            <p className="xl:text-center lg:text-left text-sm text-transparent bg-clip-text bg-gradient-to-r from-neon-pink to-cyan-600">Made with <span className="text-red-600">❤️</span> in NYC by <a className="hover:text-black hover:font-bold" href="https://www.whiterabbitdesign.studio/" target="_blank" rel="noreferrer">White Rabbit Design</a></p>
          </div>
        </div>
      </footer>
    )
