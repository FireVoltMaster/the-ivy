          ...
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center">
            ...
            >
              ...
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                ...
                <div className="absolute top-0 right-0 pt-4 lg:pr-4 sm:block">
                  <button
                    type="button"
                ...
                {/* <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse"> */}
                  ...
                  {/* <button
                    type="button"
                    className="inline-flex w-full justify-center rounded-md border border-transparent bg-red-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 sm:ml-1 sm:w-auto sm:text-sm"
                    onClick={() => setOpen(false)}
                  >
                    Deactivate
                  </button>
