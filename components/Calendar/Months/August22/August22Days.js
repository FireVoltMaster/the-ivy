...
const days = [
    ...
    { date: '2022-08-06', isCurrentMonth: true, events: [] },
    {
      ...
      isCurrentMonth: true,
      events: [
        { id: 1, name: 'Movie Night', time: '10PM', datetime: '', href: '/event-test' },
    ...
    { date: '2022-08-10', isCurrentMonth: true, events: [] },
    {
      date: '2022-08-11',
      isCurrentMonth: true,
      events: [{ id: 3, name: 'Sip N Paint', time: '8PM', datetime: '', href: '/event-test' }],
    },
    ...
    { date: '2022-08-15', isCurrentMonth: true, events: [] },
    {
      ...
      isCurrentMonth: true,
      // isToday: true,
      events: [{ id: 6, name: "Learn to Tie Dye", time: '3PM', datetime: '', href: '/event-test' }],
    },
    ...
    { date: '2022-08-25', isCurrentMonth: true, events: [] },
    {
      ...
      // isSelected: true,
      events: [
        { id: 4, name: 'Beach party', time: '1PM', datetime: '', href: '/event-test' },
        { id: 5, name: 'Wiz Kalifa signing', time: '8PM', datetime: '', href: '/event-test' },
      ],
    },
    { date: '2022-08-27', isCurrentMonth: true, events: [] },
    { date: '2022-08-28', isCurrentMonth: true, events: [
        { id: 2, name: 'GRAND OPENING', time: '6PM', datetime: '', href: '/event-test' }
    ] },
    ...
    {
      date: '2022-09-07',
      events: [{ id: 7, name: 'End of Summer Bash', time: '9PM', datetime: '', href: '/event-test' }],
    },
