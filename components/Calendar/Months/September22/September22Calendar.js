import days from "./September22Days";
...
function classNames(...classes) {
  ...
  export default function SeptemberCalendar() {
    return (
                      ...
                      {day.events.slice(0, 2).map((event) => (
                        <li key={event.id}>
                          <a href={event.href} className="group flex">
                            <p className="flex-auto truncate font-medium text-gray-900 group-hover:text-indigo-600 hover:scale-125">
                              {event.name}
                            </p>
                            <time
